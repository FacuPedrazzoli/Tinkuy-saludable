...
const WARM_MESSAGE =
  '¡Hola Tinkuy! 🌱 Estaba viendo la tienda y me gustaría hacerles una consulta sobre sus productos.'

export function WhatsAppButton() {
  const href = `${siteConfig.social.whatsapp}?text=${encodeURIComponent(WARM_MESSAGE)}`
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/20 transition-transform duration-300 hover:scale-110 hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-[#25D366]/40"
    >
