  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (loginData?.adminLogin) {
        ...
        // AuthProvider only reads the session on mount + every 60s. Without
        // this it would still see user=null after we just set the cookies,
        // so ProtectedRoute would bounce back to /login?reason=session_expired.
